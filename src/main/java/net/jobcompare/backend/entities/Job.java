...
public class Job {
    ...
    public Job(String title, String company, String location, Integer costOfLivingIndex, Float yearlySalary, 
    String hiringTeamEmail, Long timeOfPosting, Integer teamId){
        this.title = title;
