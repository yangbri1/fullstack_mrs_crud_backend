...
public class Job {
    ...
    // 'modId' field in this 'Job' schema must be non-falsy (not empty)
    ...
    String hiringTeamEmail, Moderator moderator){
        this.title = title;
        ...
        this.moderator = moderator; // this now reference Moderator instead of Integer data type since 'moderator' is PRIMARY_KEY of 'moderators' now
    }
