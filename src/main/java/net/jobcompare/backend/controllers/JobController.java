...
/* import '@RequestMapping' annotation to for 'DRY-er code for each mapping */
@RequestMapping("/jobs")
// @CrossOrigin(origins = "http://localhost:5173")
// enable CORS to allow requests from GitHub (static) Pages domain --- DO NOT include full URL path, only the origin (what's included) otw will fail
@CrossOrigin(origins = "https://yangbri1.github.io")
public class JobController {
    ...
    ** 3) Spring officially prefers this */
    ...
    // @GetMapping("/jobs")
    // '@GetMapping("/jobs")' could just become below w/ '@RequestMapping' annotation at class level
    @GetMapping
    ...
    @GetMapping("/work_arrangement/{workArrangement}")
