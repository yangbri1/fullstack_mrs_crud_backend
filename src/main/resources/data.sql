...
MERGE INTO moderators (mod_id, username, email) KEY(mod_id) VALUES (3001, 'Alice', 'alice@wonderland.com');
MERGE INTO moderators (mod_id, username, email) KEY(mod_id) VALUES (3002, 'Bob', 'bob@saget.com');
MERGE INTO moderators (mod_id, username, email) KEY(mod_id) VALUES (3003, 'Charlie', 'charlie@chocolate.com');
MERGE INTO moderators (mod_id, username, email) KEY(mod_id) VALUES (3004, 'Diana', 'diana@autumn.com');
MERGE INTO moderators (mod_id, username, email) KEY(mod_id) VALUES (3005, 'Eve', 'eve@christmas.com');
MERGE INTO moderators (mod_id, username, email) KEY(mod_id) VALUES (3006, 'Frank', 'frank@ocean.com');
...
('Alpha Tester', 'Test out in-house games before release', 'EA', 'Los Angeles', 3, 'HYBRID', 45000.0, 'testing@ea.com', 3003, CURRENT_TIMESTAMP),
('Backend Developer', 'Build and maintain RESTful APIs', 'Spotify', 'New York City', 4, 'REMOTE', 120000.0, 'careers@spotify.com', 3004, CURRENT_TIMESTAMP),
('Bay Harbor Butcher', 'Diving enthusiast', 'Miami Metro Police Department', 'Miami', 3, 'ONSITE', 95000.0, 'mpd@bayharbor.com', 3005, CURRENT_TIMESTAMP),
('Jack the Ripper', 'Make clean surgical incisions when extracting parts', 'London Ward', 'London', 10, 'ONSITE', 85000.0, 'daytime@surgeon.edu', 3005, CURRENT_TIMESTAMP),
('Muffin Man', 'Bake goods are on another level', 'Local Bakery', 'Venice Beach', 5, 'HYBRID', 130000.0, 'peopleofnyc@nyc.net', 3006, CURRENT_TIMESTAMP);
